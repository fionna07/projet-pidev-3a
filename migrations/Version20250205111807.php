 ...
 */
final class Version20250205111807 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE terrain (id INT AUTO_INCREMENT NOT NULL, proprietaire_id INT DEFAULT NULL, adresse VARCHAR(255) NOT NULL, surface DOUBLE PRECISION NOT NULL, type_sol VARCHAR(255) NOT NULL, prix DOUBLE PRECISION NOT NULL, status VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, latitude DOUBLE PRECISION NOT NULL, longitude DOUBLE PRECISION NOT NULL, INDEX IDX_C87653B176C50E4A (proprietaire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
