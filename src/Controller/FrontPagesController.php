...
class FrontPagesController extends AbstractController
{
    ...
    #[Route('/shop', name: 'app_shop_equipement')]
    public function shopEquipement(EntityManagerInterface $entityManager): Response
    {
        $equipements = $entityManager->getRepository(\App\Entity\Equipement::class)->findAll();
    
        return $this->render('equipement/shopequipement.html.twig', [
            'equipements' => $equipements,
        ]);
    }

    #[Route('/chat', name: 'app_equipement_recommandation')]
    public function equipementRecommandation(): Response
    {
        return $this->render('equipement/Airecommandation.html.twig');
    }
