...
class Terrain
{
    ...
    #[ORM\Column(length: 255)]
    #[Assert\NotBlank(message: "Le propriétaire est obligatoire.")]
    #[Assert\Length(
        min: 2,
        max: 255,
        minMessage: "Le nom du propriétaire doit comporter au moins {{ limit }} caractères.",
        maxMessage: "Le nom du propriétaire ne doit pas dépasser {{ limit }} caractères."
    )]
